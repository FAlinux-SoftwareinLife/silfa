package screen.application.spread {
	...
	public class SpreadApplication extends ApplicationAbstract {
		
		private const APP_NAME:String = ApplicationName.SPREAD;
		
		public function SpreadApplication() {
