package model.google.apps.data {
	...
	public class PreFileData extends AppsDataAbstract implements IData {

		private const DATA_NAME:String = DataName.PRE_FILE;

		private var result:Object;

		public function PreFileData() {
		...
		private function requestPreData():void {

			var _token:String;
			var _header:URLRequestHeader;
			var _loader:URLLoader;
			var _fileUpload:FileUpload = new FileUpload();
			var _docData:Object = {title: FileName.PRESENTATION, mimeType: GoogleHTTPRequestInfo.MIME_TYPE_PRE}
